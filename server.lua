...
local treasureItems = {
    [1] = {chance = 4, id = 'steelscraps', name = 'Steel Scrap', quantity = math.random(1,3), limit = 111},
    [2] = {chance = 4, id = 'rustycarparts', name = 'Rusty Car Parts', quantity = math.random(1,3), limit = 111},
    [3] = {chance = 3, id = 'scrapmetal', name = 'Scrap Metal', quantity = math.random(1,3), limit = 111},
    [4] = {chance = 3, id = 'rustymetal', name = 'Rusty Metal', quantity = math.random(1,3), limit = 111},
    [5] = {chance = 1, id = 'lockpick', name = 'Lockpick', quantity = math.random(1,3), limit = 111},
    [6] = {chance = 1, id = 'highgradefemaleseed', name = 'Female Seed', quantity = math.random(1,3), limit = 111},
    [7] = {chance = 1, id = 'opal', name = 'Opal', quantity = math.random(1,3), limit = 111},
    [8] = {chance = 1, id = 'brokenlaptop', name = 'Broken Laptop', quantity = math.random(1,3), limit = 111},
    [9] = {chance = 2, id = 'brokenphone', name = 'Broken Phone', quantity = math.random(1,3), limit = 111},
    [10] = {chance = 1, id = 'wallet', name = 'Wallet', quantity = math.random(1,3), limit = 111},
   }
